...
public class GeneratorBlockEntity extends BlockEntity implements Inventory, EnergyStorage, Tickable,
  ...
  public void setInvStack(int slot, ItemStack stack) {
    ...
    boolean bl = !stack.isEmpty() && stack.isItemEqualIgnoreDamage(itemStack) && ItemStack
        .areTagsEqual(stack, itemStack);
      ...
      if (burning) {
        ...
        if (this.burnTime == 0) {
          this.world.setBlockState(this.pos,
              world.getBlockState(pos).with(AbstractFurnaceBlock.LIT, false));
        }
        ...
        this.world
            .setBlockState(this.pos, world.getBlockState(pos).with(AbstractFurnaceBlock.LIT, true));
