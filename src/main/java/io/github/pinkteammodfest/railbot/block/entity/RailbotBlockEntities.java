...
public class RailbotBlockEntities {
    ...
    public static final BlockEntityType<GeneratorBlockEntity> GENERATOR = register("coal_generator", BlockEntityType.Builder.create(GeneratorBlockEntity::new, RailbotBlocks.GENERATOR).build(null));
